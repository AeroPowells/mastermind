from text_content import formatting
from display import code_colors, clue_colors
...
def instructions():
  print(f"""
    ...
    1 = Red    -> {code_colors('1')}
    2 = White  -> {code_colors('2')}
    3 = Green  -> {code_colors('3')}
    4 = Yellow -> {code_colors('4')}
    5 = Purple -> {code_colors('5')}
    6 = Brown  -> {code_colors('6')}
    ...
    {code_colors('1')}{code_colors('4')}{code_colors('6')}{code_colors('3')}
    Clues:
    {clue_colors('*')} {clue_colors('?')} {clue_colors('?')}
